...
const QuestionDisplay: React.FC<QuestionDisplayProps> = ({ 
    ...
    const renderQuestionType = () => {
        switch (question.question_type) {
            case 'learn':
                return <LearnQuestionComponent question={question} onAnswerSubmit={onAnswerSubmit} currentAnswerData={currentAnswerData} />;
            case 'choice_to_char':
            ...
            case 'detect':
                return <DetectQuestionComponent question={question} onAnswerSubmit={onAnswerSubmit} currentAnswerData={currentAnswerData} />;
            default:
